...
class ParseUsers implements IParseUserService
{
    ...
    private Response|array|null $response;
    ...
    public function makeRequestByUrl(): static
    {
        ...
        if ($this->response->getStatusCode() != 200)
            throw new AppMainException("Invalid status code in " . __METHOD__);
    ...
    {
        $this->response = json_decode($this->response->getBody(), true); //!TODO: подключить сюда генератор
